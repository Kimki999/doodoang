import TheFool from "../assets/00_the_fool.jpg";
import TheMagician from "../assets/01_the_magician.jpg";
import TheHighPreistess from "../assets/02_the_high_priestess.jpg";
import TheEmpress from "../assets/03_the_empress.jpg";
...
import TheHermit from "../assets/09_the_hermit.jpg";
import WheelofFortune from "../assets/10_the_wheel.jpg";
import Justice from "../assets/11_justice.jpg";
import TheHangedMan from "../assets/12_hanged_man.jpg";
import Death from "../assets/13_Death.jpg";
import Temperance from "../assets/14_Temperance.jpg";
import TheDevil from "../assets/15_The_Devil.jpg";
import TheTower from "../assets/16_The_Tower.jpg";
