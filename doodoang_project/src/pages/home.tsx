    ...
    return (
        <div className="flex items-center justify-center min-h-screen">
            <div className="mx-auto max-w-3/4 overflow-hidden rounded-xl bg-white shadow-md text-black">
                <div className="flex items-center justify-center m-3 text-3xl roboto-font-bold">
                    DooDoang
                </div>
                <div className="m-2">
                   <Random></Random> 
                ...
                <div className="flex items-center justify-center m-2">
                    <Picbutton onClick={() => navigate("/FlipCard",{replace: true,state:getRandom()})} max_h={10} base={RandomButton} hover={ClickedRandomButton}></Picbutton>
                </div>
