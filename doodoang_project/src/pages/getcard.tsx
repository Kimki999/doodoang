                ...
                <div className="w-full max-w-screen-md bg-white shadow-md rounded-xl overflow-hidden grid grid-rows-[auto_1fr_auto] min-h-[90vh]">
                    ...
                    <main className="grid grid-cols-3 gap-4 p-4">
                        <div className="col-span-1 flex flex-col justify-between">
                            <img className="flex-1 flex items-center justify-center"src={path} alt=""></img>
                    ...
                    <footer className="TemplateColor text-white p-4 text-center roboto-font-bold items-center justify-center">
                        made by CSCMU66
                    </footer>
                </div>
            </div>
