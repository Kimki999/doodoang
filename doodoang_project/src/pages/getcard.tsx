    ...
    return (
        <FadeIn>
            <div className="flex justify-center items-center min-h-screen">
                <div className="bg-indigo-400 max-w-1/2 h-3/4 flex justify-center items-center rounded-xl" >
                    <div className="m-2">
                        ...
                        <main className="bg-white grid grid-cols-3 grid-row-3">
                            <div className="col-span-1 row-span-2">
                                <div className="grid-row-3">
                                    <div className="row-span-2 flex justify-center items-center m-2">
                                        <img className="2xl:rounded-xl xl:rounded-xl lg:rounded-xl md:rounded-xl rounded-sm" src={path}></img>
                                    </div>
                        ...
                        <footer className="TemplateColor noto-sans-thai-font text-center text-white rounded-b-lg p-2 shadow-xl">
                            <div className="text-red-500 2xl:text-[14px] xl:text-[12px] lg:text-[10px] md:text-[8px] sm:text-[6px] text-[4px]">
                                อย่าลืมมาแลกของที่ระลึกฟรีได้ที่บูธชั้น 3 ห้อง 308 น้าาา
                            </div>
                            <div className="noto-sans-thai-font-bold 2xl:text-[12px] xl:text-[10px] lg:text-[8px] md:text-[6px] sm:text-[4px] text-[3px]">
                                made by CSCMU66 
                            </div>
                        </footer> 
                    </div>
